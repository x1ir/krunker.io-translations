...
settings.client.resetSettings Сброс настроек
...
settings.viewmodel.roundArms Закругленная модель рук
settings.viewmodel.show.melee Показывать Нож
settings.viewmodel.show.ads Скрывать Оружие при прицеливании
settings.viewmodel.toggleAim Переключить Прицеливание
settings.viewmodel.show.hands Показывать Руки
...
settings.editing.speedLines Линии Скорости
settings.editing.spdLinesCol Цвет Скоростных Линий
settings.editing.score.color Цвет очков
...
settings.editing.hue Цветовая Палитра (В игре)
settings.editing.menuHue Цветовая Палитра (В меню)
settings.editing.vignette Виньетка
...
settings.shaders.header Входные Данные Шейдера
settings.mods.header Кастомизация
settings.mods.load Загружать Моды
settings.mods.logo Разрешить Изменение Логотипа
settings.mods.auto Автозагрузка Мода
settings.mods.borders Границы Прицела
settings.mods.borderCol Границы Прицела
settings.mods.borderOpac Непрозрачность Границ Прицела
settings.mods.scope Изображение Прицела
settings.mods.scope.paste URL Изображения Прицела
...
settings.mods.damage Изображение Оверлея при получении урона
settings.mods.damage.paste URL Изображения Оверлея при получении урона
...
windows.loadout.melee Нож
windows.loadout.hat Шляпа
windows.loadout.back Предмет на спину
windows.loadout.waist Предмет на талию
windows.loadout.shoe Обувь
windows.loadout.face Лицо
windows.loadout.spray Спрей
windows.loadout.color.skin Цвет Кожи
windows.loadout.color.chat Цвет Имени в Чате
...
windows.mods.none Моды не найдены
windows.mods.header Менеджер Модификаций
windows.mods.guide Руководство по Модификациям
...
windows.controls.backward Назад
...
windows.controls.swap Вторичное Оружие
windows.controls.melee Нож
windows.controls.equip Снаряжение
windows.controls.chat Чат
windows.controls.voice Голосовая Связь
windows.controls.list Список Игроков
windows.controls.board Таблица Лидеров
windows.controls.interact Взаимодействовать
windows.controls.interactSec Вторичное Взаимодействие
...
windows.store.voucher Использовать купон
...
event.doubleXP 2x Class XP включен для этого матча
...
ranked.sync Отсутствуют данные синхронизации
...
modes.round.win Ваша команда выиграла этот раунд
...
commands.smite.on.other Smite — включено для {0}
commands.smite.off.other Smite – отключено для {0}
